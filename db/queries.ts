...
export const getCourseById = cache(async (courseId: number) => {
    const data = await db.query.courses.findFirst({
        ...
        // To do: Acrescentar unidades e lissões
    })
...
export const getCourseProgress = cache(async () => {
    ...
    const firstUncompletefLesson = unitsInActiveCourse
    ...
    return {
        activeLesson: firstUncompletefLesson,
        activeLessonId: firstUncompletefLesson?.id,
    }
})
